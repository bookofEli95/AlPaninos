  ...
  return (
    <View className="flex-1 bg-[#FAF6F0] pt-16 px-4">
      <View className="flex-row items-center mb-6">
        ...
        <Text className="text-2xl font-bold text-[#1C1917] ml-2">Customer Support</Text>
      </View>
      ...
      <ScrollView keyboardShouldPersistTaps="handled" keyboardDismissMode="on-drag" showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <View>
            <Text className="text-xs text-[#78716C] uppercase font-bold tracking-wider">Call Us</Text>
            <Text className="text-lg font-bold text-[#1C1917]">{SUPPORT_PHONE}</Text>
          </View>
        </TouchableOpacity>

        <Text className="text-lg font-bold text-[#1C1917] mb-2">Leave a Comment or Review</Text>
        <TextInput
        ...
        >
          {submitting ? (
            ...
            <Text className="text-[#F4ECE1] font-bold text-lg">Submit</Text>
          )}
        </TouchableOpacity>
      </ScrollView>
    </View>
