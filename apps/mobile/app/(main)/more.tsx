...
export default function MoreScreen() {
  ...
  return (
    <View className="flex-1 bg-[#FAF6F0] pt-16 px-4">
      <Text className="text-3xl font-extrabold font-inter-extrabold text-[#1C1917] mb-6">More</Text>
          ...
          {MENU_ITEMS.map((item, index) => (
            ...
            >
              <View className="flex-row items-center">
                ...
                <Text className="text-base font-semibold font-inter-semibold text-[#1C1917]">{item.label}</Text>
              </View>
